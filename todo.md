...
- [ ] Publish only code, compact metrics, digests, and safely hostable artifacts; never push oversized binary weights to GitHub history, and save any observatory evidence checkpoint only after full verification.
